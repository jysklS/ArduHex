...
protected:
    ...
    void                add_motor_raw_6dof(int8_t motor_num, float roll_fac, float pitch_fac, float yaw_fac, float forward_fac, float lateral_fac, uint8_t testing_order); //JL
    ...
    float               _forward_factor[AP_MOTORS_MAX_NUM_MOTORS]; // JL
    float               _lateral_factor[AP_MOTORS_MAX_NUM_MOTORS]; // JL
    float               _thrust_rpyt_out[AP_MOTORS_MAX_NUM_MOTORS]; // combined roll, pitch, yaw and throttle outputs to motors in 0~1 range
    float               _fwlat_out[AP_MOTORS_MAX_NUM_MOTORS]; // JL
